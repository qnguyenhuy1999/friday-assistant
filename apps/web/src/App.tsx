...
import { SkillImprovementProposalDetailPage } from "./pages/skill-improvement-proposal-detail-page";
    ...
    <main>
      ...
      {route.view === "skill" && route.id && (
        <SkillDetailPage
          ...
          onViewImprovementProposal={(id) =>
            navigate({ view: "skill-improvement-proposal", id })
          }
        />
      )}
      {route.view === "skill-improvement-proposal" && route.id && (
