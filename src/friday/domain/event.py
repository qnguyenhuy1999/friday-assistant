...
class RunEventType(StrEnum):
    ...
    WORKFLOW_NODE_DISPATCHED = "workflow_node_dispatched"
    WORKFLOW_NODE_SUCCEEDED = "workflow_node_succeeded"
    WORKFLOW_NODE_FAILED = "workflow_node_failed"
    WORKFLOW_NODE_CANCELLED = "workflow_node_cancelled"
    WORKFLOW_NODE_BLOCKED = "workflow_node_blocked"
